...
public class PriorityQueueHeapTests {
  ...
  public void testEmpty() {
    PriorityQueueHeap<Integer> q = new PriorityQueueHeap<>();
  ...
  @Test
  public void testHeapProperty() throws IllegalAccessException {
  ...
  public void testHeapify() {
    ...
    for (int i = 1; i < LOOPS; i++) {
      ...
      PriorityQueueHeap<Integer> pq = new PriorityQueueHeap<>(lst);
  ...
  public void testContainment() {
    ...
    String[] strs = { "aa", "bb", "cc", "dd", "ee" };
    PriorityQueueHeap<String> q = new PriorityQueueHeap<>(strs);
    q.remove("aa");
  ...
  @Test
  public void testContainmentRandomized() throws IllegalAccessException {
  ...
  public void sequentialRemoving(Integer[] in, Integer[] removeOrder) {
    ...
    PriorityQueueHeap<Integer> pq = new PriorityQueueHeap<>(in);
    PriorityQueue<Integer> PQ = new PriorityQueue<>();
    for (int value : in)
      PQ.offer(value);
  ...
  @Test
  public void testRemovingDuplicates() throws IllegalAccessException {
  ...
  @Test
  public void testRandomizedPolling() throws IllegalAccessException {
    ...
    for (int i = 0; i < LOOPS; i++) {
      ...
      PriorityQueueHeap<Integer> pq2 = new PriorityQueueHeap<>();
  ...
  @Test
  public void testRandomizedRemoving() throws IllegalAccessException {
  ...
  @Test
  public void testPQReusability() throws IllegalAccessException {
    ...
    for (int sz : SZs) {
      ...
      for (int i = 0; i < sz / 2; i++) {
        ...
        // Sometimes add a new number into the PriorityQueueHeap
        if (0.25 < Math.random()) {
